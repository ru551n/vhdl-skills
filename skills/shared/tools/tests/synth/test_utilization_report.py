"""Tests for vhdl_tools.synth.utilization_report (Vivado hierarchical utilization).
...
from vhdl_tools.synth.utilization_report import UtilizationReportError, get_utilization_report
